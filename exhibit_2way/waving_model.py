...
frame_receiver = camera.Camera(0)
...
def left_right_hand_classify(image, results):
...
while True:
    ...
    result_string, probabilities, results = waving_system.image_hand_pose_predict(RGB_image)
    ...
    BGR_image = left_right_hand_classify(BGR_image, results)  # 可移除
